...
import logo from '../assets/images/Adsız tasarım.png'
import { Link } from 'react-router-dom';
import { AiOutlineFacebook } from "react-icons/ai";
import privacyPolicyTxt from '../assets/Privacy_Policy_EN.txt';
import termsTxt from '../assets/T_C_EN.txt';


const Footer = () => {
  // Function to open privacy policy in a new tab
  const openPrivacyPolicy = () => {
    window.open(privacyPolicyTxt, '_blank');
  };
  const openTerms = () => {
    window.open(termsTxt, '_blank');
  };
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 font-figtree">
            ...
            <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row font-figtree">
                ...
                <ul className="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                 <li style={{ color: "#112d42" }}><Link to="/contact" className="hover:text-gray-400" style={{ color: "#112d42" }} onClick={() => window.scrollTo(0, 0)}>Contact us</Link>
</li> 
