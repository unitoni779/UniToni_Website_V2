...
const ServicesSection = () => {
    return (
        <div className="bg-gradient-to-b from-white to-white">
            <div className=" h-full max-w-6xl px-10 mx-auto xl:px-0 mt-5" style={{ fontFamily: "'GT Eesti', sans-serif" }}>
              
                <div className="w-full">
              
            <h2 className="text-3xl font-bold mb-8 text-center text-[#112d42] font-sans">
                    ...
                    <div className="flex flex-col w-full mb-5 sm:flex-row">
                            ...
                            <div className="relative h-full ml-0 mr-0 sm:mr-10">
                                ...
                                <div className="relative h-full p-5 bg-white border-2 border-blue-500 rounded-lg">
                                    <div className="flex items-center -mt-1">
                                        <h3 className="my-2 ml-3 text-lg font-bold text-gray-800 text-[#112d42] font-sans">INTEGRATIONS</h3>
                                    </div>
                                    <p className="mt-3 mb-1 text-xs font-medium text-blue-500 uppercase">------------</p>
                                    <p className="mb-2 text-gray-600 text-[#112d42] font-sans">
                        ...
                        <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                            <div className="relative h-full ml-0 mr-0 sm:mr-10">
                                ...
                                <div className="relative h-full p-5 bg-white border-2 border-yellow-500 rounded-lg">
                                    <div className="flex items-center -mt-1">
                                        <h3 className="my-2 ml-3 text-lg font-bold text-gray-800 text-[#112d42] font-sans">IMPLEMENTATION</h3>
                                    </div>
                        ...
                        <div className="w-full sm:w-1/2">
                            <div className="relative h-full ml-0 md:mr-10">
                                ...
                                <div className="relative h-full p-5 bg-white border-2 border-blue-500 rounded-lg">
                                    <div className="flex items-center -mt-1">
                                        <h3 className="my-2 ml-3 text-lg font-bold text-gray-800 text-[#112d42] font-sans">PRIVACY COMMITMENT</h3>
                                    </div>
                                    <p className="mt-3 mb-1 text-xs font-medium text-blue-500 uppercase">------------</p>
                                    <p className="mb-2 text-gray-600 text-[#112d42] font-sans">
