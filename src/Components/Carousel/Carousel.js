...
const Carousel = () => {
  ...
  const getProgressBarBackground = () => {
    return `linear-gradient(90deg, #0087f7 0%, #0087f7 ${(activeIndex + 1) / 3 * 100}%, rgba(255,255,255,0) ${(activeIndex + 1) / 3 * 100}%)`;
  };
      ...
      <div className="overflow-hidden relative">
        ...
        <div className="flex transition-transform duration-1000 ease-in-out" style={{ transform: `translateX(-${activeIndex * 100}%)` }}>
          ...
          <div className="w-full flex-shrink-0">
            <div className="relative p-10 bg-gray-100 rounded-lg">
